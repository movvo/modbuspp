...
bool modbus::modbus_connect() {
    // std::cout << "entrem connect" << std::endl;
    // std::cout << "HOST.empty " << HOST.empty() << std::endl;
    ...
    // std::cout << "creem _socket" << std::endl;
    ...
    // std::cout << "connect _socket" << std::endl;
